...
HANDLE hThread;
LPCTSTR lpszClass = TEXT("Bounce1"); //Long Poiinter Constance(상수) TSTR:TCHAR의 포인터
//즉 const TCHAR*를 뜻한다.
...
void sendmsg()
{
	...
	cData.lpData = &trans;
	HWND Dispatch = FindWindow(NULL, TEXT("bounce2"));
